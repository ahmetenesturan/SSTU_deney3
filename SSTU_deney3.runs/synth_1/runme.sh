...
HD_PWD='C:/Users/ahmet/Projects/Vivado/sstu/SSTU_deney3/SSTU_deney3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log with_MUX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source with_MUX.tcl
