...
HD_PWD='C:/Users/ahmet/Projects/Vivado/sstu/SSTU_deney3/SSTU_deney3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log with_MUX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source with_MUX.tcl -notrace
